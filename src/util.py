...
from src.model import CompensationInterval, JobType, Site
...
# ScraperAPI 配置
# USE_SCRAPERAPI = True
# SCRAPERAPI_KEY = "fe4bcf8a7d9e39102ed47da92de4b126"
...
class RequestsRotating(RotatingProxySession, requests.Session):
    ...
    def request(self, method, url, **kwargs):
        ...
        #     # 合并原始参数
        #     if "params" in kwargs:
        #         scraper_payload.update(kwargs["params"])
            
        #     url = SCRAPERAPI_URL
        #     kwargs["params"] = scraper_payload
        #     print(f"🔁 Using ScraperAPI to fetch: {original_url}")
...
def set_logger_level(verbose: int):
    ...
    if level is not None:
        for logger_name in logging.root.manager.loggerDict:
            if logger_name.startswith("JobCrawler:"):
